  ...
  <div className="container px-xl-0">
    <div className="row">
      <div className="mb-30 mb-lg-0 col-lg-3 col-sm-6 order-0">
        <img src={"./img/jobget-logo-transparent.png"} style={{width:"89px", marginBottom: "25px"}}/>
      ...
      <div className="col-lg-3 col-sm-6 order-3 order-lg-0" style={{textAlign: "center"}}>
        <img src="./img/masschallenge-boston-finalist.png" style={{width: "125px", padding: "10px"}}/>
        <img src="./img/MIT_IIC_logo.png" style={{width: "125px", padding: "10px"}}/>
      </div>
      <div className="mb-50 mb-lg-0 col-lg-3 col-sm-6 text-lg-right order-1 order-lg-0" style={{textAlign: "center"}}>
        ...
        <a href="https://itunes.apple.com/us/app/jobget/id1436462309">
          <img src="https://www.jobget.com/img/app-store-logo.png" style={{width: 150 + "px", marginTop:20 + "px"}}/>
        </a>
        <a href="https://play.google.com/store/apps/details?id=com.jobget">
          <img src="https://www.jobget.com/img/play-store-logo.png" style={{width:"150px",  marginTop:"20px"}}/>
        </a>
      </div>
    </div>
  </div>
